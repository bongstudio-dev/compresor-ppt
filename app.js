...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        es: {
            ...
            seoText: 'Comprimí PPTX y PDF en tu navegador, gratis, sin registro y sin subir tus archivos a ningún servidor.',
        ...
        en: {
            ...
            seoText: 'Compress PPTX and PDF files in your browser — free, no sign-up, no file uploads.',
